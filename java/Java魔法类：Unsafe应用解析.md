...
> 这个获取 Unsafe 实例方法比较人性化...

## 三、功能介绍

<img src="/Users/sherlock/Desktop/notes/allPics/Java/unsafe 结构.png" alt="unsafe 结构" style="zoom:150%;" />

如上图所示，Unsafe提供的API大致可分为
...
- 对象操作
  - 获取对象成员属性在内存中的偏移量
  - 非常规的对象实例化
  - 存储、获取指定偏移地址的变量值(包含延迟生效、volatile 语义)
- 线程调度
  - 线程的挂起、恢复
  - 获取、释放锁
- 系统信息获取
...
![unsafe_directByteBuffer](/Users/sherlock/Desktop/notes/allPics/Java/unsafe_directByteBuffer.png)
...
![java_cleaner](/Users/sherlock/Desktop/notes/allPics/Java/java_cleaner.png)
...
![cleaner 源码](/Users/sherlock/Desktop/notes/allPics/Java/cleaner 源码.png)
...
![atomicInt](/Users/sherlock/Desktop/notes/allPics/Java/atomicInt.png)
...
![atomicInt 示意图](/Users/sherlock/Desktop/notes/allPics/Java/atomicInt 示意图.png)
...
![lambda 实例编译](/Users/sherlock/Desktop/notes/allPics/Java/lambda 实例编译.png)
...
![unsafe_非常规实例化](/Users/sherlock/Desktop/notes/allPics/Java/unsafe_非常规实例化.png)
...
![unsafe_数组操作](/Users/sherlock/Desktop/notes/allPics/Java/unsafe_数组操作.png)
...
![unsafe_内存屏障](/Users/sherlock/Desktop/notes/allPics/Java/unsafe_内存屏障.png)
...
![unsafe_validate](/Users/sherlock/Desktop/notes/allPics/Java/unsafe_validate.png)
...
![unsafe_内存页实现](/Users/sherlock/Desktop/notes/allPics/Java/unsafe_内存页实现.png)
