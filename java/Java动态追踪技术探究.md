...
![JSP 文件处理过程](/Users/sherlock/Desktop/notes/allPics/Java/JSP 文件处理过程.jpg)
...
类 `java.lang.instrument.Instrumentation`

看完文档之后，我们发现这么两个接口：redefineClasses 和 retransformClasses。一个是重新定义class，一个是修改class。这两个大同小异，看reDefineClasses的说明：
...
![BTrace 执行流程](/Users/sherlock/Desktop/notes/allPics/Java/BTrace 执行流程.jpg)
