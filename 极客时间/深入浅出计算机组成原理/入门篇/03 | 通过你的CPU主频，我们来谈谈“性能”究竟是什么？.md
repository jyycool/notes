...
![图中是我们实际系统里性能监测工具 NewRelic 中的响应时间，代表了每个外部的 Web 请求的执行时间](https://static001.geekbang.org/resource/image/4c/96/4c87a1851aeb6857a323064859da6396.png)

第二个是吞吐率（Throughput）或者带宽（Bandwidth），想要提升这个指标，你可以理解为让计算机“搬得更多”。

![服务器使用的网络带宽，通常就是一个吞吐率性能指标](https://static001.geekbang.org/resource/image/27/27/27cab77c0eec95ec29792e6c3d093d27.png)
...
![一份 SPEC 报告通常包含了大量不同测试的评分](https://static001.geekbang.org/resource/image/a5/22/a50a6cb9d3df027aeda5ee8e53b75422.png)
...
![程序实际占用的 CPU 时间一般比 Elapsed Time 要少不少](https://static001.geekbang.org/resource/image/0b/00/0b340db019d7e389a2bde4c237ee4700.jpg)
